...
ll.display()  # Output: 1 2 5 3

# 2. Delete at specific index
ll.delete_at_index(1)
ll.display()  # Output: 1 5 3
...
ll.rotate_right(2)
ll.display()  # Output: 5 3 1

# 6. Reversing linked list
ll.reverse()
ll.display()  # Output: 1 3 5
...
for i in range(8, 10):
    ll3.append(i)
ll.interleave(ll3)
ll.display()  # Output: 0 8 1 9 3 5 6 7

# 11. Returns the middle element
print(ll.get_middle())  # Output: 3

# 12. Index of 1st occurence of element
print(ll.index_of(2))  # Output: -1

# 13. Split the two linked list at specified index
ll4 = ll.split_at_index(3)
ll.display()  # Output: 0 8 1

ll4.display()  # Output: 9 3 5 6 7